...
func printCell(val int, today bool) {
    escape := "\033[48;2;240;253;244m\033[38;2;0;0;0m"  // Very light green background for 0 commits
    switch {
    case val >= 1 && val <= 3:
        escape = "\033[48;2;198;239;206m\033[38;2;0;0;0m"  // Light green for 1-3 commits
    case val >= 4 && val <= 6:
        escape = "\033[48;2;134;203;147m\033[38;2;255;255;255m"  // Sage green for 4-6 commits
    case val >= 7 && val <= 10:
        escape = "\033[48;2;69;161;85m\033[38;2;255;255;255m"  // Normal green for 7-10 commits
    case val > 10:
        escape = "\033[48;2;35;134;54m\033[38;2;255;255;255m"  // Darker green (lighter than forest) for 10+ commits
    }

    if today {
        escape = "\033[1;37;45m"  // Keep the today highlight as is
    }
